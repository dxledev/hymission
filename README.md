...
| `niri_mode_wallpaper_zoom_layer_namespaces` | string | `awww-daemon` | Comma-separated ECMAScript regular expressions matched against the complete background layer namespace. Plain names remain exact matches; use `.*` for a wildcard. |
