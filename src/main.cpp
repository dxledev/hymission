...
#define STRING_CONF(name, value) addStringConfig("plugin:hymission:" name, Config::STRING{value})
    ...
    INT_CONF("multi_workspace_expand_selected_window", 1);
    INT_CONF("overview_focus_follows_mouse", 1);
    INT_CONF("overview_center_cursor_on_hover_focus", 1);
    ...
    FLOAT_CONF("niri_single_ws_gap_multiplier", -1.0F);
    FLOAT_CONF("niri_single_ws_gap_pixels", -1.0F);
    FLOAT_CONF("niri_multi_ws_scale", 0.18F);
    FLOAT_CONF("niri_workspace_gap", -1.0F);
    ...
    INT_CONF("niri_mode_show_empty_workspaces_btwn", 1);
    ...
    FLOAT_CONF("niri_drag_preview_alpha", 0.75F);
    ...
    INT_CONF("close_special_workspaces_on_open", 1);
    INT_CONF("post_close_cross_scope_debounce_ms", 0);
